...
function iniciar() {
  ...
  if (acao.value == 0) {
    document.getElementById('erro_acao').innerHTML = "Add the minutes of your section"
    acao.focus()
  } else if (pausa.value == 0) {
    document.getElementById('erro_pausa').innerHTML = "Add the minutes of your break"
    pausa.focus()
  } else if (sessoes.value == 0) {
    document.getElementById('erro_sessoes').innerHTML = "Add the number of study sections"
    sessoes.focus()
  } else {
...
function momentoAcao() {
  ...
  if (localStorage.getItem('sessoes') != '1') {
    document.getElementById('title_sessao').innerHTML = sessoes_valor + ' sections - you can do it!'
  } else {
    document.getElementById('title_sessao').innerHTML = sessoes_valor + ' more section and you are done - keep going!'
  }
